...
namespace KaikeiSystemBody.views.reports
{
    ...
    /// </summary>
    partial class ShikinSyuushiKessanUchiwakeCol10 : DataDynamics.ActiveReports.ActiveReport
    {
        public ShikinSyuushiKessanUchiwakeEngine Engine { get; private set; }

        public ShikinSyuushiKessanUchiwakeCol10() {
            //
            ...
            Engine = new ShikinSyuushiKessanUchiwakeEngine(numCols: 10);
