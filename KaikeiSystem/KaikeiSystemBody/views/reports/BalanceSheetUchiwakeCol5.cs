...
{
    /// <summary>
    /// BalanceSheetUchiwake の概要の説明です。
    /// </summary>
    partial class BalanceSheetUchiwakeCol5 : DataDynamics.ActiveReports.ActiveReport
    {
/*        public BalanceSheetUchiwakeEngine Engine {
            get;
            private set;
        }
        */

        public BalanceSheetUchiwakeCol5() {
            //
