...
namespace KaikeiSystemBody.models.db.tables
{
    ...
    /// 会計伝票明細
    /// </summary>
    class ZenkiKurikoshiKamoku : AbstractTable
    {
        public const string TABLE_NAME = "zenki_kurikoshi_kamoku";

        public ZenkiKurikoshiKamoku(AbstractDatabase db, string tableName = TABLE_NAME)
            : base(db, tableName) {
